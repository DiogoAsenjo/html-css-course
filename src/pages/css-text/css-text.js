...
function CSSText() {
  return (
    <div>
      ...
      <p>
        So, you saw that we can edit a lot of things about links, the style, the
        style after you clicked one time, while the cursor of the mouse is
        hovering the link e even the style while you're clicking, below you'll
        se the first link without any style and the second styled just like the
        image above:
      </p>
      <ul>
        <li>
